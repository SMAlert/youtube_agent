...
transcribe_video = Agent(
    ...
    description="""Transcribe the spoken content from a YouTube video using its URL.""",
...
transcribe_agent = Agent(
    ...
    description="Given a YouTube URL, extract and return the transcript of the video using LLM.",
    instruction=prompt.TRANSCRIBE_AGENT_INSTR,
    tools=[
        AgentTool(agent=transcribe_video),
    ],
